  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          <li>Dashboard</li>
          <li class="active">Purchase Return Home</li>
        </ol>
      </section>
      ...
      <section class="content">
          <div class="row">
            ...
            {{-- search --}}
            <!-- Search FIX -->
              <form class="form" action="{{ url('/purchase/return_home/getrange') }}" method="post">
                {{csrf_field()}}
                <div class="box">
                  <div class="box-body">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      ...
                      <input class="form-control" type="text" id="idbuying" name="idbuying" pattern=".{3,}" title="3 characters minimum" @if(isset($arraydata[3])) value="{{$arraydata[3]}}" @endif>
                  ...
                  <div class="box-footer">
                    <div class="pull-right">
                      <a style="width : 90px;" href="{{url('purchase/return_home')}}" type="button" onclick="return confirm('Are you sure want to reset?')" class="btn btn-warning">Reset</a>
            ...
            {{-- tables --}}
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Data Purchase Return</h3>
                </div>

                <div class="box-body table-responsive">

                @if(DB::table('level_akses')->where('id_menu', '3')->where('id_level',auth::user()->level_id)->first()->c==1)
                  <a href="{{ url('/purchase/return_home/add') }}" type="button" class="btn btn-primary">Created New Return Items</a><br><br>
                  @endif
                  <table id="table-home" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        <th>Created Date</th>
                        <th>ID Purchase Return</th>
                        <th>ID Buying</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        {{--@if(DB::table('level_akses')->where('id_menu', '3')->where('id_level',auth::user()->level_id)->first()->u==1)
                        <td><a style="width:90px;" href="{{ url('/purchase/return_home/edit/'.$item->id) }}" type="button" class="btn btn-info">Edit</a></td>
                        @endif--}}
                        @if(DB::table('level_akses')->where('id_menu', '3')->where('id_level',auth::user()->level_id)->first()->d==1)
                        {{--<td><a style="width:90px;" href="{{ url('/purchase/return_home/delete/'.$item->id.'/'.$item->stock_id.'/'.$item->total_qty_return.'/'.$item->stock_sell) }}" type="button" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this data ?')">Delete</a></td>--}}
                        <td><a style="width:90px;" href="{{ url('/purchase/return_home/addnext/'.$item->id) }}" type="button" class="btn btn-info">Edit</a></td>
                        <td><a style="width:90px;" href="{{ url('/purchase/return_home/delete/'.$item->id) }}" type="button" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this data ?')">Delete</a></td>
                        @endif
                      </tr>
                      @endforeach
                  ...
                  <div class="box-footer">
                    <form class="form" action="{{ url('/purchase/return_home/export') }}" method="post">
                      {{ csrf_field() }}
                      ...
                      <input type="hidden" id="idbuying" name="idbuying" @if(isset($arraydata[3])) value="{{$arraydata[3]}}" @endif>
      ...
      $(function () {
        ...
        var table = $('#table-home').DataTable({
          ...
          buttons: [
              {
                  extend: 'copyHtml5',
                  title: 'TUNAS ABADI 8 | Data Return',
                  exportOptions: {
                      columns: [ 0, ':visible' ]
                  }
              },
