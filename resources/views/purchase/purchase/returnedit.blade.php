          ...
          <div class="row">
            ...
            @endif
              ...
              <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ url('/purchase/return_home/do_edit/'.$tr_returpembelian->id) }}" method="post">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="return_id" id="return_id" placeholder="ID Purchase Return" value="{{ $tr_returpembelian->retur_pembelian_id }}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="pembelian_id" id="pembelian_id" placeholder="ID Buying" value="{{ $tr_returpembelian->pembelian_id }}" readonly>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="items_id" id="items_id" placeholder="ID Buying" value="{{ $tr_returpembelian->barang_id }} - {{$tr_returpembelian->items_id}}" readonly>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <select class="form-control" name="type_return" id="type_return">
                          ...
                          <option @if($tr_returpembelian->type_return == '1') selected @endif value="1">Cut the Debt</option>
                          <option @if($tr_returpembelian->type_return == '2') selected @endif value="2">Change Money</option>
                          <option @if($tr_returpembelian->type_return == '3') selected @endif value="3">Replace items at the same price</option>
                          <option @if($tr_returpembelian->type_return == '4') selected @endif value="4">Trade-in Goods</option>
                        </select>
