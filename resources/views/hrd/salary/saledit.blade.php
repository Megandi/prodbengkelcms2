          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ url('/hrd/sal_home/do_edit/'.$ms_gaji->id) }}" method="post">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <select style="text-transform:uppercase" class="js-karyawan-id form-control">
                          @if(isset($ms_gaji->karyawan_id))
                            <option selected>{{$ms_gaji->karyawan_id}} - {{$ms_gaji->nama}}</option>
                          @endif
                        </select>
                       @if($errors->has('karyawan_id'))
                          <p style="font-style: bold; color: red;">{{ $errors->first('karyawan_id') }}</p>
                      @endif
                      <input type="hidden" id="karyawan_id" name="karyawan_id" value="{{$ms_gaji->karyawan_id}}">
                      <input type="hidden" id="karyawan_name" name="karyawan_name" value="{{$ms_gaji->nama}}">
                      </div>
                    </div>
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="number" min="0" class="form-control" name="salary" id="salary" placeholder="Amount Salary" value="{{$ms_gaji->gaji}}">
