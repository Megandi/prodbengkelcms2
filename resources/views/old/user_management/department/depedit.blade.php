          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ url('/usermanagement/dep_home/do_edit/'.$ms_department->id) }}" method="post">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="name" id="name" placeholder="name" value="{{$ms_department->name}}">
                      @if($errors->has('name'))
