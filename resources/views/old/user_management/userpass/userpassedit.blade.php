  ...
  <div class="wrapper">
          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ url('/usermanagement/user_pass_home/do_edit/'.$users->id) }}" method="post">
                  <div class="box-body">
    ...
    function close_window() {
      if (confirm("Are you sure you want to close this page? Any changes you made will not be saved.")) {
        window.location.replace("{{ url('/usermanagement/user_pass_home') }}");
      }
    }
