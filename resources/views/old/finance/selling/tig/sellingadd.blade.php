                ...
                <form class="form-horizontal" action="{{ url('/finance/selling_home/tig/do_add') }}" method="post" onsubmit="return validasitrue();">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="number" min="0" class="form-control" name="items_sub_total_view" id="items_sub_total_view" placeholder="Sub Total" value="{{old('items_sub_total_view')}}" onblur="calculateForm();">
