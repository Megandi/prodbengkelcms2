          ...
          <div class="row">
            ...
            @endif
              ...
              <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ url('/finance/selling_home/do_edit/'.$selling->id) }}" method="post">
                  <div class="box-body">
                  ...
                  <table id="table-home" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        {{--<td><a style="width:90px;" href="{{ url('/finance/selling_home/delete_selling_detail2/'.$detail->id.'/'.$selling->id)}}" type="button" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this data ?')">Delete</a></td>--}}
                      </tr>
                     @endforeach
