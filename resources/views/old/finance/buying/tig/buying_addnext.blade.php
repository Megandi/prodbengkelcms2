...
<body class="hold-transition skin-blue sidebar-mini">
          ...
          <div class="row">
            ...
            <div class="box box-info">
              ...
              <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ url('/finance/buying_home/tig/do_add') }}" method="post">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="hidden" name="id_pembelian" value="{{$buying->id}}">
                        <input type="text" required class="form-control" name="pembelian_id" id="pembelian_id" placeholder="Buying ID" value="{{$buying->pembelian_id}}" readonly="true">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="number" required min="0" class="form-control" name="items_sub_total_view" id="items_sub_total_view" placeholder="Sub Price" value="{{old('items_sub_total_view')}}" onblur="calculateForm();">
                  ...
                  <input type="hidden" name="buyingid" value="{{ $buying->id }}">
                </form>
              </div>
            </div>
            ...
            <div class="box box-primary">
                ...
                <table id="table-home" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a style="width:90px;" href="{{ url('/finance/buying_home/tig/delete_buying_detail/'.$detail->id.'/'.$buying->id.'/'.$totaluang.'/'.$idretur)}}" type="button" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this data ?')">Delete</a></td>
                    </tr>
                   @endforeach
              ...
              <div class="box-footer">
                ...
                <a style="width:90px;" href="{{ url('/finance/buying_home/tig/checkout/'.$buying->id.'/'.$totaluang.'/'.$idretur) }}" type="button" class="btn btn-success pull-right">Buy it</a>
              </div>
  ...
  <script>
    ...
    $(".js-items-id").select2({
    ajax: {
      url: "{{ url('/finance/buying_home/search_items_buying') }}",
      dataType: 'json',
      delay: 250,
