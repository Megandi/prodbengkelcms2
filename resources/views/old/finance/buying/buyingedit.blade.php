          ...
          <div class="row">
            ...
            @endif
              ...
              <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ url('/finance/buying_home/do_edit/'.$buying->id) }}" method="post">
                  <div class="box-body">
                  ...
                  <table id="table-home" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        {{--<td><a style="width:90px;" href="{{ url('/finance/buying_home/delete_buying_detail2/'.$detail->id.'/'.$buying->id)}}" type="button" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this data ?')">Delete</a></td>--}}
                      </tr>
                     @endforeach
