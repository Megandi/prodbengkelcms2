          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ url('/finance/addtional_home/do_addnext') }}" method="post">
                  <div class="box-body">
              ...
              <div class="box box-primary">
                  ...
                  <table id="table-home" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a style="width:90px;" href="{{ url('/finance/addtional_home/delete_addtional_detail/'.$detail->id.'/'.$biayalain->id)}}" type="button" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this data ?')">Delete</a></td>
                      </tr>
                     @endforeach
                ...
                <div class="box-footer">
                  <a style="width:90px;" href="{{ url('/finance/addtional_home/checkout/'.$biayalain->id) }}" type="button" class="btn btn-success pull-right">Checkout</a>
                </div>
