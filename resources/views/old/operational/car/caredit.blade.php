          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ url('/operational/car_home/do_edit/'.$ms_mobil->id) }}" method="post">
                  <div class="box-body">
  ...
  <script>
    ...
    function close_window() {
      if (confirm("Are you sure you want to close this page? Any changes you made will not be saved.")) {
        window.location.replace("{{ url('/operational/car_home') }}");
      }
    }

    $(".js-cust-id").select2({
    ajax: {
      url: "{{ url('/operational/car_home/search_cust') }}",
      dataType: 'json',
      delay: 250,
