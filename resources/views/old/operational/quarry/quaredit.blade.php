          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ url('/operational/quar_home/do_edit/'.$ms_tambang->id) }}" method="post">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="input_quarry_id" class="col-sm-2 control-label">Quarry ID <span style="color:red;">*</span></label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="quarry_id" id="quarry_id" placeholder="Quarry ID" value="{{$ms_tambang->tambang_id}}" readonly>
                      @if($errors->has('quarry_id'))
                          <p style="font-style: bold; color: red;">{{ $errors->first('quarry_id') }}</p>
                      @endif
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control name" name="quarry_name" id="quarry_name" placeholder="Name" value="{{$ms_tambang->nama}}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea style="resize: none;" class="form-control area" rows="3" name="quarry_address" id="quarry_address" placeholder="Address">{{$ms_tambang->alamat}}</textarea>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea style="resize: none;" class="form-control area" rows="3" name="quarry_office" id="quarry_office" placeholder="Office Address">{{$ms_tambang->alamat_perusahaan_tambang}}</textarea>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="number" min="0" class="form-control" name="no_telp" id="no_telp" placeholder="Contact Quarry" value="{{$ms_tambang->no_telp_perusahaan_tambang}}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="npwp" id="npwp" placeholder="NPWP" value="{{$ms_tambang->npwp}}">
                      @if($errors->has('npwp'))
  ...
  <script>
    ...
    function close_window() {
      if (confirm("Are you sure you want to close this page? Any changes you made will not be saved.")) {
        window.location.replace("{{ url('/operational/quar_home') }}");
      }
    }
