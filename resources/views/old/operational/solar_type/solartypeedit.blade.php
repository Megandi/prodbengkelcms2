  ...
  <div class="wrapper">
          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ url('/operational/solar_type_home/do_edit/'.$lt_solar->id) }}" method="post">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control name" name="name" id="name" placeholder="name" value="{{$lt_solar->name}}">
                      @if($errors->has('name'))
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="number" min="0" class="form-control" name="price" id="price" placeholder="price" value="{{$lt_solar->harga_liter}}">
                      @if($errors->has('price'))
    ...
    function close_window() {
      if (confirm("Are you sure you want to close this page? Any changes you made will not be saved.")) {
        window.location.replace("{{ url('/operational/solar_type_home') }}");
      }
    }
