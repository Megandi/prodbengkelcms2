          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ url('/operational/supp_home/do_add') }}" method="post">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="supp_name" id="supp_name" placeholder="Name" value="{{old('supp_name')}}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea style="resize: none;" class="form-control area" rows="3" name="supp_address" id="supp_address" placeholder="Address">{{old('supp_address')}}</textarea>
  ...
  <script>
    ...
    function close_window() {
      if (confirm("Are you sure you want to close this page? Any changes you made will not be saved.")) {
        window.location.replace("{{ url('/operational/supp_home') }}");
      }
    }
