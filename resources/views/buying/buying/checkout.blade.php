          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ url('/buying/buying_home/do_checkout/') }}" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <select class="form-control" name="status_payment" id="status_payment">
                          ...
                          <option @if(old('status_payment') == '1') selected @endif value="1">Paid</option>
                          <option @if(old('status_payment') == '0') selected @endif value="0">Unpaid</option>
                        </select>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <div class="input-group date" id="datetimepicker">
                          <input type="text" class="form-control for_date" name="sell_due_date" id="sell_due_date" value="{{old('sell_due_date')}}">
                          @if($errors->has('sell_dp'))
                            <p style="font-style: bold; color: red;">{{ $errors->first('sell_due_date') }}</p>
                          @endif
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="box-footer">
                    <a href="{{ url('finance/buying_home/addnext/'.$buying->id) }}" style="width:90px;" type="submit" class="btn btn-default">Back</a>
  ...
  var status_payment = "x";
    ...
    function close_window() {
      if (confirm("Are you sure you want to close this page? Any changes you made will not be saved.")) {
        window.location.replace("{{ url('/buying/selling_home') }}");
      }
    }
