          ...
          <div class="row">
            ...
            <div class="box box-primary">
                ...
                <table id="table-home" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a style="width:90px;" href="{{ url('/buying/buying_home/delete_buying_detail/'.$detail->id.'/'.$buying->id)}}" type="button" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this data ?')">Delete</a></td>
                    </tr>
                   @endforeach
              ...
              <div class="box-footer">
                ...
                <a style="width:90px;" href="{{ url('/buying/buying_home/checkout/'.$buying->id) }}" type="button" class="btn btn-success pull-right">Buy it</a>
              </div>
