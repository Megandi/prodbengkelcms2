            ...
            @endif
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Detail Buying</h3>
                </div>
