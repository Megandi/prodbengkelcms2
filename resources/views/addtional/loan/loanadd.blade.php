          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ url('/addtional/loan_home/do_add') }}" method="post">
                  <div class="box-body">
  ...
  <script>
    ...
    function close_window() {
      if (confirm("Are you sure you want to close this page? Any changes you made will not be saved.")) {
        window.location.replace("{{ url('/addtional/loan_home') }}");
      }
    }

    $(".js-user-id").select2({
    ajax: {
      url: "{{ url('/addtional/loan_home/search_loan_user') }}",
      dataType: 'json',
      delay: 250,
