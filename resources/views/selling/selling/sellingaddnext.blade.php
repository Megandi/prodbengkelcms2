          ...
          <div class="row">
            ...
            @endif
              ...
              <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ url('/selling/selling_home/do_add') }}" method="post" onsubmit="return validasitrue();">
                  <div class="box-body">
            ...
            <div class="box box-primary">
                ...
                <table id="table-home" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a style="width:90px;" href="{{ url('/selling/selling_home/delete_selling_detail/'.$detail->id.'/'.$selling->id)}}" type="button" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this data ?')">Delete</a></td>
                    </tr>
                   @endforeach
              ...
              <div class="box-footer">
                ...
                <a style="width:90px;" href="{{ url('/selling/selling_home/checkout/'.$selling->id) }}" type="button" class="btn btn-success pull-right">Sell it</a>
              </div>
            </div>
        </div>
      </div>
