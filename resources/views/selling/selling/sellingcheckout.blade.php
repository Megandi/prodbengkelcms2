          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ url('/selling/selling_home/do_checkout/') }}" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="hidden" id="cust_deposit" name="cust_deposit" value="{{old('cust_deposit')}}">
                      </div>
                    </div>
                  ...
                  <div class="box-footer">
                    <a href="{{url('finance/selling_home/addnext/'.$selling->id)}}" style="width:90px;" class="btn btn-default">Back</a>
