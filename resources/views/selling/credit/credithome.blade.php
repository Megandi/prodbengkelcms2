    ...
    <div class="content-wrapper">
      ...
      <section class="content">
          <div class="row">
            ...
            {{-- search --}}
            <!-- Search FIX -->
              <form class="form" action="{{ url('/selling/credit_home/getrange') }}" method="post">
                {{csrf_field()}}
                <div class="box">
                  <div class="box-body">
                    <div class="col-md-6">
                  ...
                  <div class="box-footer">
                    <div class="pull-right">
                      <a style="width : 90px;" href="{{url('selling/credit_home')}}" type="button" onclick="return confirm('Are you sure want to reset?')" class="btn btn-warning">Reset</a>
            ...
            {{-- tables --}}
              <div class="box box-primary">
                ...
                <div class="box-body table-responsive">
                  {{-- <a href="{{ url('/selling/credit/add') }}" type="button" class="btn btn-primary">Add New Houling</a><br><br> --}}
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        @if($item->status_piutang > 0)
                          <td><a style="width:90px;" href="{{ url('/selling/credit_home/edit/'.$item->id) }}" type="button" class="btn btn-info">Edit</a></td>
                        @else
                  ...
                  <div class="box-footer">
                    <form class="form" action="{{ url('/selling/credit_home/export') }}" method="post">
                      {{ csrf_field() }}
