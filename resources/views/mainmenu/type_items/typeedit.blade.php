  ...
  <div class="wrapper">
          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ url('/mainmenu/items_type_home/do_edit/'.$ms_kategori_barang->id) }}" method="post">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control name" name="name" id="name" placeholder="name" value="{{$ms_kategori_barang->name}}">
                      @if($errors->has('name'))
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <select class="form-control" name="type_date" id="type_date">
                          ...
                          <option @if($ms_kategori_barang->type_date == "1") selected @endif value="1">Age</option>
                          <option @if($ms_kategori_barang->type_date == "2") selected @endif value="2">Time</option>
                        </select>
                    ...
                    <div class="form-group" id="age_year" @if($ms_kategori_barang->type_date != 1) style="display: none;" @endif>
                      <label for="input_year" class="col-sm-2 control-label">Year <span style="color:red;"></span></label>
                      <div class="col-sm-10">
                        <input type="number" min="0" max="99" class="form-control" name="year" id="year" placeholder="year" value="{{$ms_kategori_barang->year}}">
                      @if($errors->has('year'))
                    ...
                    <div class="form-group" id="age_month" @if($ms_kategori_barang->type_date != 1) style="display: none;" @endif>
                      <label for="input_month" class="col-sm-2 control-label">Month <span style="color:red;"></span></label>
                      <div class="col-sm-10">
                        <input type="number" min="0" max="99" class="form-control" name="month" id="month" placeholder="Month" value="{{$ms_kategori_barang->month}}">
                      @if($errors->has('month'))
                    ...
                    <div class="form-group" id="age_day" @if($ms_kategori_barang->type_date != 1) style="display: none;" @endif>
                      <label for="input_day" class="col-sm-2 control-label">Day <span style="color:red;"></span></label>
                      <div class="col-sm-10">
                        <input type="number" min="0" max="99" class="form-control" name="day" id="day" placeholder="Day" value="{{$ms_kategori_barang->day}}">
                      @if($errors->has('day'))
                    ...
                    <div class="form-group" id="time" @if($ms_kategori_barang->type_date != 2) style="display: none;" @endif>
                      <label for="input_expiry" class="col-sm-2 control-label">Date Expiry <span style="color:red;">*</span></label>
                      <div class="col-sm-10">
                        <div class='input-group date' id='datetimepicker'>
                          <input type="text" class="form-control for_date" name="expiry" id="expiry" value="{{$ms_kategori_barang->expiry_date}}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="checkbox" @if($ms_kategori_barang->is_inventory == 1) checked @endif name="inven" id="inven" placeholder="inven" value="1">
                      @if($errors->has('inven'))
    ...
    function close_window() {
      if (confirm("Are you sure you want to close this page? Any changes you made will not be saved.")) {
        window.location.replace("{{ url('/mainmenu/items_type_home') }}");
      }
    }
