  ...
  <div class="wrapper">
          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ url('/mainmenu/pos_home/do_add') }}" method="post">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="input_pos" class="col-sm-2 control-label">Position Name <span style="color:red;">*</span></label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="name" id="name" placeholder="Position Name" value="{{old('name')}}">
                      @if($errors->has('name'))
    ...
    function close_window() {
      if (confirm("Are you sure you want to close this page? Any changes you made will not be saved.")) {
        window.location.replace("{{ url('/mainmenu/pos_home') }}");
      }
    }
