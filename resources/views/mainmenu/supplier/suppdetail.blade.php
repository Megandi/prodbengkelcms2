              ...
              <div class="box">
                <div class="box-body">
                  <div class="col-md-6">
                    ...
                    <input class="form-control" type="text" readonly="true" value="{{$supplier->supplier_id}}">
                    <label class="control-label">Name</label>
                    <input class="form-control" type="text" readonly="true" value="{{$supplier->nama}}">
                    <label class="control-label">No Telp</label>
                    <input class="form-control" type="text" readonly="true" value="{{$supplier->no_telp}}">
                    <label class="control-label">No Telp (Mobile)</label>
                    <input class="form-control" type="text" readonly="true" value="{{$supplier->no_hp}}">
                    <label class="control-label">Fax</label>
                    <input class="form-control" type="text" readonly="true" value="{{$supplier->fax}}">
                    <label class="control-label">Address</label>
                    <textarea class="form-control" readonly="true">{{$supplier->alamat}}</textarea>
                  </div>
                  <div class="col-md-6">
                    <label class="control-label">Email</label>
                    <input class="form-control" type="text" readonly="true" value="{{$supplier->email}}">
                    <label class="control-label">NPWP</label>
                    <input class="form-control" type="text" readonly="true" value="{{$supplier->npwp}}">
                    <label class="control-label">No Rekening</label>
                    <input class="form-control" type="text" readonly="true" value="{{$supplier->no_rekening}}">
                    <label class="control-label">Rekening Name</label>
                    <input class="form-control" type="text" readonly="true" value="{{$supplier->nama_rekening}}">
                    <label class="control-label">Bank Name</label>
                    <input class="form-control" type="text" readonly="true" value="{{$supplier->bank_nama}}">
                  </div>
                </div>
            ...
            <div class="col-md-12">
              ...
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#tab_1" data-toggle="tab">Transaksi Pembelian</a></li>
                  <li><a href="#tab_2" data-toggle="tab">Transaksi Hutang</a></li>
